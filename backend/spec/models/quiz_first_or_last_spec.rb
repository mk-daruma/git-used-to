  ...
  describe "validates presence" do
    ...
    context "quiz_first_or_last_statusの値が入力されていない場合" do
      ...
      it "エラーになること" do
        ...
        expect(quiz_first_or_last.errors.messages[:quiz_first_or_last_status]).to include "can't be blank"
      end
    end
  end
  ...
  describe "quiz_first_or_lasts_count_must_be_within_limit" do
    context "同じquizデータに紐づいたquiz_first_or_lastのデータが二つ存在する場合" do
      ...
      it "エラーが出ること" do
        ...
        expect(new_quiz_first_or_last.errors.messages[:base]).to include "quiz_first_or_lasts count limit: 2"
      end
    end
  end
end
